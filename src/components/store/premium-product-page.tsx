...
function BrandMark() {
  return <a href="#topo" className="flex shrink-0 items-center gap-3" aria-label="NOME NOVO — início"><span className="grid size-9 place-items-center border border-primary/50 bg-primary/10 text-primary"><Navigation className="size-5" /></span><span className="text-sm font-extrabold uppercase tracking-[0.16em]">NOME NOVO</span></a>;
}
